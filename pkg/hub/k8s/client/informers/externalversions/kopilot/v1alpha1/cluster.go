...
import (
	...
	versioned "github.com/smartxworks/kopilot/pkg/hub/k8s/client/clientset/versioned"
	internalinterfaces "github.com/smartxworks/kopilot/pkg/hub/k8s/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/smartxworks/kopilot/pkg/hub/k8s/client/listers/kopilot/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KopilotV1alpha1().Clusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KopilotV1alpha1().Clusters(namespace).Watch(context.TODO(), options)
			},
		},
		&kopilotv1alpha1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kopilotv1alpha1.Cluster{}, f.defaultInformer)
}
