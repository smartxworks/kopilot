...
type FakeClusters struct {
	Fake *FakeKopilotV1alpha1
	ns   string
}

var clustersResource = schema.GroupVersionResource{Group: "kopilot.smartx.com", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "kopilot.smartx.com", Version: "v1alpha1", Kind: "Cluster"}
